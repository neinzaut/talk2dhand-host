...
from nltk.tokenize import word_tokenize  # Import tokenizer from NLTK
...
def speech_recognition():
    try:
        while True:
            ...
            if tokens and tokens[0] == "letter":
                character = tokens[1]  # Get the character after "letter"
            ...
            elif tokens and tokens[0] == "number":
                character = tokens[1]  # Get the character after "number"
                image_folder = r"static\images\hand sign none"
                image_path = os.path.join(image_folder, f"{character}.png")
                print(image_path)
                if os.path.exists(image_path):
